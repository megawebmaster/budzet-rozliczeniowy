...
class BudgetTable extends Component {
  ...
  render() {
    const { label, categories, data, editableRealValues, className, onAdd } = this.props;
          ...
          { categories.map(category => {
            ...
            return (
              <TableRow key={`budget-row-${category.id}`}>
                ...
                <TableCell>
                  <PriceInput value={values.planned} onChange={() => { console.log('Create change handler'); }} />
                </TableCell>
                <TableCell>
                  <PriceInput value={values.real} disabled={!editableRealValues} onChange={() => { console.log('Create change handler'); }} />
                </TableCell>
              </TableRow>
            );
          })}
