...
const messages = {
  ...
  'share-budget.header': 'Udostępnianie budżetu',
  'share-budget.reminder-title': 'Ważne',
  'share-budget.reminder-content': 'Pamiętaj o przekazaniu hasła szyfrującego odbiorcy - w przeciwnym wypadku nie' +
    ' będzie mógł odczytać zapisanych danych! Dobrym pomysłem jest przekazanie go osobiście lub przesłanie SMSem.',
  'share-budget.close': 'Zamknij',
  'share-budget.access.header': 'Kto ma dostęp',
  'share-budget.access.permission-view': 'Przeglądanie',
  'share-budget.access.permission-edit': 'Edycja',
  'share-budget.access.permission-share': 'Udostępnianie',
  'share-budget.access.owner': 'Właściciel',
